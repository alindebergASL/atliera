...
export function parseSourceDocument(
  ...
  const value: SourceDocument = {
    ...
    origin_content_sha256: reqString(raw, "origin_content_sha256", path, errors),
    stored_content_sha256: reqString(raw, "stored_content_sha256", path, errors),
    transformation_manifest_sha256: nullableString(
      raw,
      "transformation_manifest_sha256",
      path,
      errors,
