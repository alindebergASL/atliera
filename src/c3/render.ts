...
function draftPage(context: FrozenC3AccountContext, record: C3GenerationRecord, note: string, recordedCorrection: string | undefined,
  ...
  const initialWarning = recordedCorrection !== undefined && record.revision === null ? '<p class="meta brief-qualification"><strong>Recorded initial — before correction.</strong> Not recommended meeting copy.</p>' : "";
  ...
  const recordedHelp = recordedCorrection === undefined ? "" : record.revision === null
