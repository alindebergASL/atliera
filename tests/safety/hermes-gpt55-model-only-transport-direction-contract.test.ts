...
test("safety: Hermes GPT-5.5 direction records provider route without authorizing this operator session", () => {
  ...
  for (const required of [
    ...
    /live-product-preview-gpt55-comparison-status\.md/i,
    /bounded comparison signal/i,
    /not a launch\/product\/production readiness or default-model-selection claim/i,
