...
Status: Accepted; customer-facing surface implications superseded prospectively by [ADR 0004](0004-calm-product-surface-and-internal-package-inspector.md). Fresh-system, Graph, validation, and no-legacy-runtime decisions remain active.
