...
export async function executeAccountIntelligenceRefresh(
  ...
  const receipt: AccountIntelligenceEffectReceipt = {
    ...
    requestedMaxOutputTokens: providerResult.receipt.requestedMaxOutputTokens,
    requestedLocalOutputTokenCeiling: providerResult.receipt.requestedLocalOutputTokenCeiling,
    transmittedProviderOutputTokenCeiling: providerResult.receipt.transmittedProviderOutputTokenCeiling,
    observedOutputTokens: providerResult.receipt.observedOutputTokens,
    externalOutputTokenEnforcement: providerResult.receipt.externalOutputTokenEnforcement,
    structuredOutputEnforcement: providerResult.receipt.structuredOutputEnforcement,
