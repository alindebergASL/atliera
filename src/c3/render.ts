...
import { projectAccountResearch, renderAccountResearch, accountResearchTopicLink } from "./account-research.ts";
...
/* Account workspace: locally drawn atmosphere, editorial hierarchy, no external assets. */
:root{--sage:#e5e9df;--stone:#efebe4;--plum:#56344d;--blue:#56344d;--paper:#f8f6f0;--ink:#302c29;--muted:#635d56;--line:#d9d3c8}
body{background:radial-gradient(ellipse at 85% 0%,#ebe9e2 0,transparent 55%),var(--paper)}
header,main,footer,.recorded-mode{width:min(1200px,calc(100% - 64px))}
header{display:flex;align-items:center;justify-content:space-between;gap:20px;padding:14px 0 0}.identity{flex:1}.brand{font-weight:500;font-size:28px;letter-spacing:-1.3px}.journey-nav{margin-top:0;gap:22px}.account-identity{font-size:14px;color:var(--muted);font-weight:500}.journey-nav a{color:var(--muted);text-decoration:none}.journey-nav a[aria-current]{color:var(--plum);border-color:var(--plum)}
.button,button{background:var(--plum);border-color:var(--plum);box-shadow:0 2px 4px #35213012}.button.secondary,button.secondary{background:transparent;color:var(--plum)}.quiet-link{display:inline-flex;align-items:center;gap:8px;min-height:44px;font-size:14px;color:var(--plum);text-decoration:underline;text-decoration-thickness:1px;text-underline-offset:4px;max-width:100%}
.account-workspace{padding-top:12px}.account-hero{position:relative;isolation:isolate;display:flex;align-items:center;justify-content:space-between;gap:28px;margin:0;padding:30px 28px;min-height:206px;overflow:hidden;border:1px solid #e4dfd5;border-radius:8px 8px 0 0;background:#faf8f3;box-shadow:0 6px 25px #413b2c08}.account-title{position:relative;z-index:1;max-width:76%;min-width:0}.account-title h1{font:500 clamp(30px,3.6vw,48px)/1.1 Georgia,serif;letter-spacing:-1.1px;margin:6px 0 10px;text-wrap:balance}.account-subtitle{margin:0 0 6px;font-size:15px}.account-title .eyebrow{font-size:11px}.account-actions{position:relative;z-index:1;flex-shrink:0;display:flex;flex-direction:column;align-items:flex-end;max-width:240px}.account-actions .hero-actions{margin:0;display:flex;flex-direction:column;align-items:flex-end;gap:0}.account-actions .button{min-width:140px}.research-entry{margin-top:5px}.account-atmosphere{position:absolute;inset:0 0 0 auto;width:62%;z-index:-1;overflow:hidden;background:radial-gradient(ellipse at 85% 0%,#dce1dc 0,transparent 65%),linear-gradient(110deg,transparent,#e7e2da)}.account-atmosphere:after{content:"";position:absolute;inset:0;background:linear-gradient(90deg,#faf8f3,transparent 70%)}.account-atmosphere i{position:absolute;display:block;width:110%;height:150px;bottom:-70px;right:-18%;border-radius:50% 40% 0 0;transform:rotate(-10deg);background:linear-gradient(135deg,#cdd6c5,#bec9bb);box-shadow:0 -12px 38px #b9b6a321}.account-atmosphere i:nth-child(2){bottom:-82px;right:22%;transform:rotate(12deg);background:#dad9cd}.account-atmosphere i:nth-child(3){bottom:-112px;right:-35%;height:160px;background:linear-gradient(135deg,#baa7b1,#d8cbc9);transform:rotate(-18deg)}
.account-topics{display:flex;gap:22px;overflow-x:auto;overscroll-behavior-x:contain;padding:0 10px;border-bottom:1px solid var(--line);scrollbar-width:thin}.account-topics a{display:inline-flex;align-items:center;flex-shrink:0;min-height:54px;font-size:14px;text-decoration:none;color:var(--muted);padding:0 3px;border-bottom:2px solid transparent}.account-topics a:hover,.account-topics a:focus-visible{color:var(--plum);border-bottom-color:var(--plum)}.account-topics a:first-child{color:var(--plum)}
.account-readout{display:grid;grid-template-columns:minmax(0,1.9fr) minmax(260px,1fr);gap:36px;padding:30px 8px;border-bottom:1px solid var(--line)}.account-readout>*{min-width:0}.account-readout h2{font:500 clamp(25px,2.6vw,35px)/1.16 Georgia,serif;letter-spacing:-.6px;text-wrap:balance;margin-bottom:12px;max-width:740px}.account-readout p:not(.eyebrow):not(.support){font-size:16px;line-height:1.6;margin:8px 0}.account-readout .support{margin-bottom:0}.account-glance{align-self:start;padding:18px 20px;background:linear-gradient(135deg,#efede5,#f3f0e9);border:1px solid #e6e0d6;border-radius:4px}.account-glance h3{font:500 21px Georgia,serif}.account-glance dl{margin:12px 0 0}.account-glance dl>div{display:grid;grid-template-columns:minmax(0,.9fr) minmax(0,1.2fr);gap:12px;border-top:1px solid #dcd6cb;padding:7px 0;font-size:13px}.account-glance dt,.account-glance dd{margin:0}.account-glance dt strong{font-weight:400}.account-readout .account-glance p.meta{font-size:12px;line-height:1.5;color:var(--muted)}
.account-columns{display:grid;grid-template-columns:minmax(0,1.25fr) minmax(0,1fr);gap:32px}.account-columns>div,.account-columns>section{min-width:0}.account-columns>div+div,.account-inquiry>section{border-left:1px solid var(--line);padding-left:32px}.account-section{padding:26px 8px;border-bottom:1px solid var(--line);scroll-margin-top:18px}.account-section h2{font-size:26px;margin-bottom:10px;letter-spacing:-.35px}.section-intro{font-size:14px;color:var(--muted);margin:0 0 18px;line-height:1.55}.account-reading{border-top:1px solid var(--line);padding:18px 0;scroll-margin-top:20px}.account-reading:last-child{padding-bottom:0}.account-reading h3{font:500 21px/1.25 Georgia,serif;margin:0 0 9px}.account-reading p{font-size:15px;line-height:1.65;margin:7px 0}.account-reading p.reading-limit{font-size:13px;color:var(--muted);padding-left:12px;border-left:2px solid #b6c2ad}.account-reading .support,.account-readout .support{font-size:12px;gap:2px 8px}.account-reading .support span,.account-readout .support span{flex-basis:100%}.account-workspace .support a{background:transparent;padding:2px 0;font-size:12px;min-height:36px;margin-right:8px}.account-reading p.discovery-period{font:650 12px/1.5 ui-sans-serif,system-ui,sans-serif;color:var(--plum)}.entity-boundaries{margin-top:18px}.entity-boundaries ul{padding-left:20px}.entity-boundaries li,.entity-boundaries p{font-size:14px}.discovery-list{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:28px}.discovery-list:has(>article:only-child){grid-template-columns:minmax(0,740px)}.account-inquiry{background:linear-gradient(135deg,#eff0e7a6,transparent);margin-top:8px;padding:0 14px}.account-questions{list-style:none;padding:0;margin:0}.account-questions li{font:500 19px/1.45 Georgia,serif;padding:16px 0;border-top:1px solid var(--line)}.account-questions .quiet-link{display:flex;font-family:ui-sans-serif,system-ui,sans-serif;font-size:13px}.account-inquiry .checks h2{font-size:21px}.account-inquiry .checks li{font-size:14px}.account-inquiry .checks{margin-bottom:0}.section-heading{display:flex;align-items:center;justify-content:space-between;gap:20px}.research-source{border-top:1px solid var(--line);padding:8px 0}.research-source>summary{font-size:16px;color:var(--ink)}.research-source>summary .source-scope{display:block;padding-left:18px;font-size:12px;font-weight:400;color:var(--muted)}.research-excerpt{margin-left:18px;border-top:1px solid var(--line);scroll-margin-top:20px}.account-research .source-text{max-height:420px}.account-workspace .account-details{max-width:none}.account-workspace .technical-detail{margin-top:18px}.account-workspace [id]:target{outline:2px solid #b8a3b0;outline-offset:5px}.account-workspace .source-section{font-size:14px}
.unreviewed-research{margin:22px 0 30px;padding:22px clamp(12px,3vw,26px);background:#f4f0e9;border-left:3px solid #92748a;border-radius:4px}.unreviewed-research h2{font-size:25px}.research-group{margin-top:24px;scroll-margin-top:20px}.research-group>h3{font:500 22px/1.3 Georgia,serif}.research-inspection{border-top:1px solid var(--line);padding:12px 0}.research-inspection>summary{font-size:15px;line-height:1.6;padding:4px 0;min-height:44px}.research-summary{font-weight:500}.research-inspection .reading-expand{display:block;margin-top:5px}.research-inspection-body{padding:4px 0 4px 16px}.research-inspection blockquote{white-space:pre-wrap;overflow-wrap:anywhere}.research-inspection p,.research-inspection a{overflow-wrap:anywhere}.research-inspection .reading-limit{font-size:14px;border-left:2px solid #b6c2ad;padding-left:12px}.research-topic-entry{margin:14px 0}.research-topic-entry a{font-size:13px;min-height:44px;display:inline-flex;align-items:center}
@media(min-width:701px) and (max-width:1100px){header,main,footer,.recorded-mode{width:calc(100% - 48px)}.account-readout{gap:24px;grid-template-columns:minmax(0,1.5fr) minmax(240px,1fr)}.account-columns{gap:24px}.account-columns>div+div,.account-inquiry>section{padding-left:24px}.account-title{max-width:72%}.account-hero{padding:26px 22px}.account-topics{gap:17px}.account-identity{display:none}}
@media(max-width:700px){header,main,footer,.recorded-mode{width:calc(100% - 32px)}header{gap:10px;align-items:center;padding-top:8px;flex-wrap:wrap}.brand{font-size:26px;white-space:nowrap}.identity{flex:0 0 auto}.account-identity{display:none}.journey-nav{gap:14px;justify-content:flex-end}.journey-nav a{font-size:12px;min-height:44px}.recorded-mode>summary{font-size:12px}.account-workspace{padding-top:6px}.account-hero{display:block;min-height:0;padding:18px 16px;border-radius:6px 6px 0 0}.account-title{max-width:none}.account-title h1{font-size:clamp(29px,7.2vw,38px);letter-spacing:-.8px;line-height:1.12}.account-subtitle{font-size:13px;line-height:1.5}.account-title .proposed-cue{font-size:12px;line-height:1.5;margin:6px 0}.account-actions{max-width:none;flex-direction:row;justify-content:space-between;align-items:center;gap:10px;margin-top:12px;flex-wrap:wrap}.account-actions .hero-actions{align-items:flex-start;flex-direction:row;gap:8px}.account-actions .button{min-width:0;font-size:13px;padding:10px 13px}.account-actions .quiet-link{font-size:12px}.account-actions .research-entry{margin:0}.account-atmosphere{width:100%;opacity:.7}.account-atmosphere:after{background:linear-gradient(100deg,#faf8f3,transparent 95%)}.account-topics{gap:18px;padding:0 6px}.account-topics a{min-height:48px;font-size:13px}.account-readout{grid-template-columns:minmax(0,1fr);gap:18px;padding:22px 4px}.account-readout h2{font-size:28px;line-height:1.18}.account-readout p:not(.eyebrow):not(.support){font-size:15px;line-height:1.55}.account-glance{padding:14px 16px}.account-glance dl{margin-top:8px}.account-glance dl>div{grid-template-columns:minmax(0,1fr) minmax(0,1.4fr);font-size:12px;padding:6px 0}.account-glance h3{font-size:20px}.account-glance p.meta{margin-bottom:0!important}.account-columns,.discovery-list{grid-template-columns:minmax(0,1fr);gap:0}.account-columns>div+div,.account-inquiry>section{border-left:0;padding-left:4px}.account-section{padding:22px 4px}.account-section h2{font-size:24px}.account-reading{padding:16px 0}.account-reading h3{font-size:21px}.account-reading p{font-size:15px}.account-reading p.reading-limit{font-size:13px}.account-workspace .support a{min-height:44px}.account-inquiry{padding:0 10px;margin-inline:-4px}.section-heading{align-items:flex-start;flex-direction:column;gap:0}.research-excerpt{margin-left:8px}.account-research .source-text{padding:10px;font-size:12px}.evidence-panel-head{gap:10px}.evidence-panel-head h2{font-size:18px}.evidence-panel-head button{font-size:12px;padding:10px}.account-questions li{font-size:18px}}
@media(prefers-reduced-motion:reduce){*,*:before,*:after{scroll-behavior:auto!important;animation:none!important;transition:none!important}}

.reading-detail>summary{position:relative;list-style:none;color:var(--ink);padding:0 22px 0 0;font-weight:400}.reading-detail>summary::-webkit-details-marker{display:none}.reading-detail>summary:after{content:"+";position:absolute;right:0;top:0;color:var(--plum);font:400 24px/1 Georgia,serif}.reading-detail[open]>summary:after{content:"−"}.reading-detail>summary h3{margin-bottom:7px}.reading-teaser{display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:2;overflow:hidden;font:400 14px/1.6 ui-sans-serif,system-ui,sans-serif;color:var(--muted)}.reading-expand{display:block;font:500 12px/1.5 ui-sans-serif,system-ui,sans-serif;color:var(--plum);margin-top:8px}.reading-detail[open] .reading-teaser,.reading-detail[open] .reading-expand{display:none}.reading-detail[open]>summary{margin-bottom:12px}.reading-body{padding-bottom:8px}.reading-body .support{margin-bottom:0}

.research-source>h3{font:500 21px/1.3 Georgia,serif;margin:10px 0 4px}.research-source>p.source-scope{font-size:13px;color:var(--muted);margin:4px 0}.research-source>.support{margin:6px 0}.research-source>.support>span{font-size:12px}.research-source>details>summary{font-size:13px}
...
function shell(title: string, body: string, csrf: string, context: FrozenC3AccountContext, recorded: boolean,
  ...
  const nav = (name: string, route: string, current: C3PageState["page"]) => `<a id="journey-${current}" href="${route}"${page === current ? ' aria-current="page"' : ""}>${name}</a>`;
...
function home(frozen: FrozenC3AccountContext, hasDraft: boolean, recorded: boolean, revisionPending: boolean): string {
  ...
  const researchPeopleLink = accountResearchTopicLink(publicResearch, "people");
  const researchTechnologyLink = accountResearchTopicLink(publicResearch, "technology");
  const eligible = !context.ownerCorrections.some(item => item.text.includes("not enabled"));
  ...
  const rows = (topic: AccountTopic) => notes(topic).map(note => {
    const expandable = ["priorities", "people", "technology"].includes(topic);
    const contents = `<h3>${esc(note.title)}</h3>${note.period ? `<p class="discovery-period">${esc(note.period)}</p>` : ""}${noteBody(note)}`;
    return `<article id="reading-${esc(note.id)}" class="account-reading">${expandable ? `<details class="reading-detail"><summary><h3>${esc(note.title)}</h3><span class="reading-teaser">${esc(note.text)}</span><span class="reading-expand">Read context & evidence <span aria-hidden="true">↗</span></span></summary><div class="reading-body">${noteBody(note)}</div></details>` : contents}</article>`;
  }).join("");
  const section = (topic: AccountTopic, title: string, introduction = "") => (notes(topic).length || (topic === "technology" && researchTechnologyLink)) ? `<section id="account-${topic}" class="account-section" tabindex="-1" aria-labelledby="heading-${topic}"><h2 id="heading-${topic}">${esc(title)}</h2>${introduction ? `<p class="section-intro">${esc(introduction)}</p>` : ""}${rows(topic)}${topic === "technology" ? researchTechnologyLink : ""}</section>` : "";
  const sourceDates = (source: EvidenceDisplay["source"]) => `<p class="meta">${esc(source.publisher)} · Published ${esc(humanDate(source.publicationDate))} · Event ${esc(humanDate(source.eventDate))} · Current through ${esc(humanDate(source.evidenceCurrentThrough))}</p><p class="meta">Acquired ${esc(source.retrievedAt)}. Acquisition is not publication or currentness.</p>`;
  ...
  const research = `<section id="account-research" class="account-section account-research" tabindex="-1" aria-labelledby="heading-research"><div class="section-heading"><div><p class="eyebrow">Evidence & research</p><h2 id="heading-research">The retained source library</h2></div><a class="quiet-link" href="#account-topics">Back to account topics ↑</a></div><p class="section-intro">${sources.length} supplied sources. Exact excerpts, scope and dates remain available here. These historical context sources are unchanged. Research inspection makes no live lookup.</p>${renderAccountResearch(publicResearch)}<h3>Historical context sources</h3>${sources.length === 0 ? '<p>No retained sources are available. The account has no source-backed orientation to inspect.</p>' : sources.map((source, sourceIndex) => `<article class="research-source" data-source-id="${esc(source.sourceId)}"><h3>${esc(source.title)}</h3><p class="source-scope">${esc(source.entity.name)} · ${source.excerpts.length} excerpts</p><p class="support"><span>Exact retained excerpts</span>${refs(source.excerpts.map(excerpt => excerpt.evidenceId), `Research · ${source.title}`)}</p><details><summary>Source dates, scope &amp; retained text</summary>${sourceContext(source)}${source.excerpts.map(excerpt => {
  ...
  const hasPeople = notes("people").length || projection.passages.length || related.length || researchPeopleLink;
  const topicLinks: readonly [string, string, boolean][] = [
    ["overview", "Overview", true], ["priorities", "Priorities", notes("priorities").length > 0],
    ["people", "People & context", !!hasPeople], ["technology", "Technology", notes("technology").length > 0 || !!researchTechnologyLink],
    ["discoveries", "Discoveries", true], ["hypotheses", "Hypotheses", notes("hypotheses").length > 0], ["unknowns", "Unknowns", true], ["research", "Evidence", true],
  ];
  ...
  return `<main id="main" class="account-workspace" tabindex="-1"><section class="account-hero" aria-label="Account identity"><div class="account-title"><p class="eyebrow">Account Intel</p><h1>${esc(account.accountName)}</h1><p class="account-subtitle">${esc(account.admittedContext.sector ?? "Sector not established")} · ${esc(account.admittedContext.geography ?? "Geography not established")}</p><p class="proposed-cue">${isCuratedContext(frozen) ? "Agent-curated public context · unreviewed" : "Retained public research · summaries unreviewed"}</p></div><div class="account-actions"><div class="hero-actions">${eligible ? '<a id="account-prepare" class="button" data-account-departure href="/?prepare=1">Prepare for…</a>' : '<span class="badge">Preparation held pending C2 revision</span>'}${hasDraft ? '<a id="account-reopen" class="quiet-link" data-account-departure href="/?draft=1">Reopen session draft</a>' : ""}</div><a class="quiet-link research-entry" href="#account-research">Open research <span aria-hidden="true">↗</span></a></div><div class="account-atmosphere" aria-hidden="true"><i></i><i></i><i></i></div></section>${revisionPending ? '<div class="warning"><strong>Revision pending.</strong> The previous valid draft remains available read-only until the revision succeeds or you explicitly discard it.</div>' : ""}<nav id="account-topics" class="account-topics" aria-label="Account topics">${topicLinks.filter(([, , available]) => available).map(([id, label]) => `<a href="#account-${id}">${esc(label)}</a>`).join("")}</nav><section id="account-overview" class="account-readout" tabindex="-1" aria-labelledby="heading-overview"><div><p class="eyebrow">Account readout</p><h2 id="heading-overview">${esc(overview?.title ?? "Read the organization through its retained sources.")}</h2>${overview ? noteBody(overview) : '<p>There is not enough matched evidence for a substantive Account reading. Inspect the retained proposal and sources below; no priorities, people or technology are inferred from the account name.</p><a class="quiet-link" href="#original-account-proposal">Inspect original proposal</a>'}</div><aside class="account-glance" aria-label="Account context at a glance"><h3>At a glance</h3><dl><div><dt>Organization</dt><dd>${esc(account.admittedContext.sector ?? "Not established")}</dd></div><div><dt>Location</dt><dd>${esc(account.admittedContext.geography ?? "Not established")}</dd></div><div><dt><strong>Sources used</strong></dt><dd>${sources.length} retained sources</dd></div><div><dt>Context requested</dt><dd>${esc(humanDate(account.requestedAt.slice(0, 10)))}</dd></div></dl><p class="meta">Context date, not evidence of currentness. Scope is limited to the retained material.</p></aside></section>${context.declaredContradictions.map(text => `<p class="warning"><strong>Conflicting context.</strong> ${esc(text)}</p>`).join("")}<div class="account-columns"><div>${section("priorities", "Priorities & initiatives", "Unreviewed source summaries of direction and plans. Present delivery status needs its own evidence.")}</div><div>${hasPeople ? `<section id="account-people" class="account-section" tabindex="-1" aria-labelledby="heading-people"><h2 id="heading-people">People &amp; operating context</h2><p class="section-intro">Unreviewed source summaries of functions and relationships. Named people are not buying owners.</p>${rows("people")}${researchPeopleLink}${projection.passages.map((passage, index) => `<article class="account-reading"><h3>${esc(passage.title)}</h3><p class="reading-limit">${esc(passage.limit)}</p><p class="support"><span>Exact source context · unreviewed</span><a id="cite-account-passage-${index + 1}" data-evidence-link data-context="${esc(passage.title)}" data-support="Exact source context · unreviewed; outside the selected proposal" href="#evidence-${evidence.length + index + 1}">Inspect source passage</a></p></article>`).join("")}${related.length ? `<details class="entity-boundaries"><summary>Organization boundaries</summary><ul>${related.map(item => `<li><strong>${esc(item.name)}</strong><p>${esc(context.relationships.find(relation => relation.entityId === item.entityId)?.relationshipToAccount ?? item.relationshipToAccount)}</p></li>`).join("")}</ul></details>` : ""}</section>` : ""}${section("technology", "Technology & services", "Unreviewed source summaries of platforms, services and investment areas; not a complete technology inventory.")}</div></div><section id="account-discoveries" class="account-section" tabindex="-1" aria-labelledby="heading-discoveries"><h2 id="heading-discoveries">Discoveries &amp; timing</h2><p class="section-intro"><strong>No earlier account review to compare.</strong> Dated discoveries and source-reported comparisons do not establish changes since a prior account review.</p><div class="discovery-list">${rows("discoveries") || '<p>No dated discovery is established in this Account reading.</p>'}</div><p class="meta">Undated material remains undated; recheck operating status before relying on it.</p></section><div class="account-columns account-inquiry"><div>${section("hypotheses", "Opportunity hypotheses", "Possible areas to investigate, not qualified opportunities. No unmet need, product fit, buyer, available budget or purchase intent is established.")}</div><section id="account-unknowns" class="account-section" tabindex="-1" aria-labelledby="heading-unknowns"><p class="eyebrow">Open questions</p><h2 id="heading-unknowns">Worth understanding</h2>${questions.length ? `<ul class="account-questions">${questions.map(item => `<li>${esc(item.question!)} <a class="quiet-link" href="#reading-${esc(item.id)}" aria-label="Context for ${esc(item.title)}">View context <span aria-hidden="true">↗</span></a></li>`).join("")}</ul>` : '<p>Specific priority, operating-role and service questions need source context first.</p>'}${accountGaps(frozen)}</section></div>${research}${priorProposal}<details class="technical-detail"><summary>Context and timing details</summary><p class="boundary">${isCuratedContext(frozen) ? "This orientation uses agent-curated public excerpts, not admitted C2 evidence." : "This orientation reuses admitted C2 evidence."} It does not claim that the legacy “meaningfully changed” bucket proves temporal change, ${isCuratedContext(frozen) ? "and no C2 owner disposition or generated C3 content exists" : "and the C2 disposition does not approve generated C3 content"}.</p><p>New Account reading notes are a read-only, unreviewed presentation. They do not rewrite the original proposal, exact excerpts, model requests or historical responses.</p>${recorded ? '<p>Prepare bridges to the existing exact recorded request; arbitrary generation remains unavailable in recorded mode.</p>' : ""}</details><dialog data-evidence-dialog aria-labelledby="evidence-panel-title"><div class="evidence-panel-head"><h2 id="evidence-panel-title">Evidence</h2><button type="button" data-evidence-close autofocus>Close evidence</button></div><p data-evidence-support class="support"></p><div data-evidence-panel-body></div></dialog></main>`;
}
